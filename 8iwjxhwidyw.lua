...
function Library:create_ui()
    ...
    function self:create_tab(title: string, icon: string)
        ...
        function TabManager:create_module(settings: any)
            ...
            Keybind.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
            ...
            if Library:flag_type(settings.flag, 'boolean') then
                ...
                Circle.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
            ...
            function ModuleManager:create_textbox(settings: any)
                ...
                Textbox.TextSize = 10
                Textbox.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
                ...
                Box.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
                Box.Parent = Checkbox
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Drag.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
                Drag.Parent = Slider
            ...
            function ModuleManager:create_feature(settings)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(0, 162, 255) or Color3.fromRGB(32, 38, 51)
                    Checkbox.Text = ""
